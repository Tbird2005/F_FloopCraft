...
const UI = {
  ...
  buildCreative(ov) {
    ...
    putMany('Nature', [
      ...
      B.SEAGRASS, B.TALL_SEAGRASS, B.KELP_FROND, B.RED_ALGAE, B.SEA_FAN, B.DEAD_SEAGRASS, B.DEAD_TALL_SEAGRASS, B.DEAD_KELP_FROND, B.DEAD_RED_ALGAE, B.DEAD_SEA_FAN,
    ]);
    putMany('Ores', [
    ...
    putMany('Utility', [
      ...
      B.TORCH, ...COLORED_TORCHS.map(t => t.floor), ...JELLY_TORCHS.map(t => t.floor), B.SEA_TORCH, B.MEGA_TORCH, B.LADDER_PX, B.ROPE_LADDER, B.SIGN, B.BED, B.SUNBED, B.PLANTATION_POT, B.SPAWNER, ...DUNGEON_SPAWNER_IDS, B.BROKEN_SPAWNER,
